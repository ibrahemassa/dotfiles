...
alias spacs='echo 123 | sudo -S pacman --noconfirm -S'
alias int_gpu='echo 123 | sudo -S envycontrol -s integrated'
alias hyb_gpu='echo 123 | sudo -S envycontrol -s hybrid --rtd3'
alias nvi_gpu='echo 123 | sudo -S envycontrol -s nvidia'
alias nvifzf='nvim $(fzf --preview="cat {}")'
...
export PATH=$PATH:/home/ibrahem/.spicetify
